...
### Dataset ###
dataset = load_dataset('json', data_files='./FINAL_20SPAN_KEYWORD_DATASET.jsonl')['train']
...
def tokenize_function(examples):
    return tokenizer(examples["text"], padding="longest", truncation=True) # "max_length"
