...
def main():
    ...
    finetune_dataset = "./Local/EXTRA_500.jsonl"               # ./MERGED_SHUFFLE_15_20.jsonl, ./FINETUNE_DATASET.jsonl
    run_nr = 3
    model_name = "KB"
    ...
    extra_train = load_from_disk("./Local/datasets/extra_train/")
    ...
    assert train.features.type == extra_train.features.type
    extended_train = concatenate_datasets([train, extra_train])
